...
COMMAND_LINE="$JAVA_CMD $XMS $XMX $HAZELCAST_ADDITIONAL -jar $LIB_DIR/sonar-application-25.2-SNAPSHOT.jar"
    ...
    then
        ...
        then
            ...
            then
                ...
                pidtest=`$PSEXE -p $pid -o args | grep "sonar-application-25.2-SNAPSHOT.jar" | tail -1`
                if [ "X$pidtest" = "X" ]
                then
...
forcestopit() {
    ...
    then
      ...
      ${JAVA_CMD} -jar "lib/sonar-shutdowner-25.2-SNAPSHOT.jar"
